...
def upgrade() -> None:
    ...
    # =========================================================================
    if not table_exists('governance_layer'):
        op.create_table(
            'governance_layer',
    ...
    # =========================================================================
    if not table_exists('pillar_1_hazard'):
        op.create_table(
            'pillar_1_hazard',
            sa.Column('id', sa.String(36), primary_key=True),
            sa.Column(
    ...
    # =========================================================================
    if not table_exists('pillar_2_vigilance'):
        op.create_table(
            'pillar_2_vigilance',
            sa.Column('id', sa.String(36), primary_key=True),
            sa.Column(
    ...
    # =========================================================================
    if not table_exists('pillar_3_restoration'):
        op.create_table(
...
def downgrade() -> None:
    ...
    # Drop tables in reverse order (children first), check if they exist
    for table_name in ['pillar_3_restoration', 'pillar_2_vigilance', 'pillar_1_hazard', 'governance_layer', 'countries']:
