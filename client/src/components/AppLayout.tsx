...
export function AppLayout({ children }: AppLayoutProps) {
  ...
  return (
    <div className="h-screen overflow-hidden bg-adl-gradient">
      ...
      <header className="lg:hidden fixed top-0 left-0 right-0 z-30 h-14 bg-adl-navy-dark/95 backdrop-blur-xl border-b border-white/5 flex items-center justify-between px-4">
      ...
      {/* ml-0 on mobile, ml-[280px] on desktop (lg+) */}
      {/* pt-14 on mobile for header space, pt-0 on desktop */}
      <main className="ml-0 lg:ml-[280px] h-screen flex flex-col overflow-hidden transition-all duration-200 relative pt-14 lg:pt-0">
        ...
        <footer className="flex-shrink-0 px-4 md:px-6 py-2 border-t border-white/5 bg-adl-navy-dark/50 backdrop-blur-sm">
